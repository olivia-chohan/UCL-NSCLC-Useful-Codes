...
# Deleted tags
X_TAGS = [
    (0x0008, 0x1050), # Peforming Physician's name
...
#KEEP FOR 4DCT ONLY (0x0008, 0x103E), # Series Description        
...
## Delete instead    (0x0008, 0x1030), # Study Description
    ...
    ### Private tags to delete ###
    (0x0009, 0x1027), # [Image actual date]
    (0x0009, 0x10e3), # [Equipment UID]
