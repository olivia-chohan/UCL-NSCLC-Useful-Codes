...
## Delete instead    (0x0008, 0x0050), # Accession Number
    (0x0070, 0x0084), # Content Creator's Name
    (0x0040, 0x2017), # Filler Order Number / Imaging Service Request
## Keep as has been hashed    (0x0010, 0x0020), # Patient ID
## Replace instead    (0x0010, 0x0030), # Patient's Birth Date
## Delete instead    (0x0010, 0x0010), # Patient's Name
## Delete instead    (0x0010, 0x0040), # Patient's Sex
    (0x0040, 0x2016), # Placer Order Number / Imaging Service Request
## Delete instead    (0x0008, 0x0090), # Referring Physician's Name
## Replace instead    (0x0008, 0x0020), # Study Date
## Delete instead    (0x0020, 0x0010), # Study ID
## Delete instead    (0x0008, 0x0030), # Study Time
...
# PUT THIS BACK IN AFTER 4DCT TEST    (0x0008, 0x103E), # Series Description
    
#    ((0x300a, 0x00b0)[1](0x0008,0x0070)) #Test nested
...
## Delete instead    (0x0010, 0x1000), # Other Patient IDs
...
# Delete instead    (0x0010, 0x0032), # Patient's Birth Time
...
## Delete instead    (0x0008, 0x1048), # Physician(s) of Record
...
## Delete instead    (0x0008, 0x103E), # Series Description
...
## Delete instead    (0x0008, 0x1030), # Study Description
...
## Delete instead    (0x0008, 0x0031), # Series Time
]

# Replace element according to the VR
X_Z_D_TAGS = [
## Delete instead    (0x0018, 0x1000), # Device Serial Number
    (0x0008, 0x0082), # Institution Code Sequence
## Delete instead    (0x0008, 0x0080), # Institution Name
## Delete instead    (0x0008, 0x1070), # Operators' Name
